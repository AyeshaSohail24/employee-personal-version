  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [typeList, empList, dataList, summary] = await Promise.all([
        ...
        activityService.getOverdueActivities(todayDate, filters),
      ...
      console.error('Failed to load overdue activities:', err);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="activities-page-wrapper" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
      ...
      <div className="page-header">
        <div>
          <h1 className="page-title">Overdue Activities</h1>
          <p className="page-description">
            Incomplete tasks past their due date requiring immediate attention
          </p>
        </div>
        <div className="directory-count-badge" style={{ backgroundColor: '#FEF2F2', color: '#DC2626', borderColor: '#FECACA' }}>
