  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [typeList, empList, dataList, summary] = await Promise.all([
        ...
        activityService.getMyActivities(currentUserId, {
          ...filters,
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-description">
            Tasks, follow-ups, and HR reviews assigned directly to you
          </p>
        </div>
        <div className="directory-count-badge">{stats.totalCount || 0} Total Tasks</div>
      </div>
