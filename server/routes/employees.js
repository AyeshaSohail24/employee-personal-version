...
export const routes = {
  "/employees": {
    ...
    async post(req, res, ctx) {
      ...
      sendJson(res, ctx.cid, 201, { employee: await db.getEmployee(id) });
    },
  },
  "/employees/{id}": {
    async get(req, res, ctx) {
      ...
      sendJson(res, ctx.cid, 200, { employee });
    },
    async patch(req, res, ctx) {
      ...
      sendJson(res, ctx.cid, 200, { employee: await db.getEmployee(ctx.params.id) });
    },
  },
